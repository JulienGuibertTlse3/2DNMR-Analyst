...
#   low_intensity_data <- normalize(low_intensity_data)
#   
#   high_clusters <- dbscan::dbscan(high_intensity_data[, c("x_scaled", "y_scaled")], eps = eps_value, minPts = 0)
#   low_clusters <- dbscan::dbscan(low_intensity_data[, c("x_scaled", "y_scaled")], eps = eps_value, minPts = 0)
#   
#   high_intensity_data$stain_id <- as.character(high_clusters$cluster)
#   low_intensity_data$stain_id <- as.character(low_clusters$cluster)
#   
